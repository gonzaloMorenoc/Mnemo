...
FAILURE_CATALOG: Dict[str, List[CiTestResult]] = {
    "checkout-suite": [
        ...
        _fail("test_pago_tarjeta_3ds_redirige",
              ...
              message="Timeout 20000ms waiting for 3DS challenge frame",
        ...
        _fail("test_email_confirmacion_pedido",
              ...
              message="SMTP connection refused on smtp.mailer.internal:587",
    ...
    "tienda-online": [
        ...
        _fail("test_ficha_producto_carga_galeria",
              error_type="TimeoutError",
              message="Timeout 10000ms waiting for product gallery images",
    ...
    "banca-movil": [
        ...
        _fail("test_login_biometrico_fallback_pin",
              error_type="TimeoutError",
              message="Timeout 15000ms waiting for biometric prompt",
        ...
        _fail("test_listado_movimientos_scroll_infinito",
              error_type="TimeoutError",
              message="Timeout 12000ms waiting for next page of movements",
        ...
        _fail("test_alta_beneficiario_valida_iban",
              ...
              trace="at IbanValidator.check (iban.validator.ts:29)",
    ...
    "portal-clientes": [
        ...
        _fail("test_recuperar_contrasena_envia_correo",
              error_type="ConnectionError",
              message="ECONNREFUSED connecting to notifications service",
    ...
    "intranet-rrhh": [
        ...
        _fail("test_fichaje_entrada_registra_hora",
              error_type="TimeoutError",
              message="Timeout 8000ms waiting for clock-in confirmation toast",
        ...
        _fail("test_aprobacion_gasto_notifica_al_manager",
              error_type="ConnectionError",
              message="connection reset by peer while calling approvals queue",
    ...
    "api-pagos": [
        _fail("test_pasarela_responde_bajo_carga",
              error_type="TimeoutError",
              message="Timeout 30000ms waiting for gateway response",
        ...
        _fail("test_conciliacion_diaria_cuadra",
              error_type="ConnectionError",
              message="connection timed out reaching settlement provider",
...
RUN_CALENDAR: List[RunSpec] = [
    ...
    RunSpec("api-pagos", "3d9b7e1", 86, 34, ("test_pasarela_responde_bajo_carga",)),
    ...
    RunSpec("tienda-online", "47cf10d", 50, 43, ("test_ficha_producto_carga_galeria",)),
    RunSpec("portal-clientes", "aa62b74", 48, 38, ("test_actualizar_datos_perfil",)),
    RunSpec("intranet-rrhh", "13e9d80", 45, 35, ("test_descarga_nomina_mes_actual",)),
    RunSpec("banca-movil", "8d47a12", 43, 40, ("test_listado_movimientos_scroll_infinito",)),
    ...
    RunSpec("api-pagos", "4f8b6d3", 29, 38, ("test_conciliacion_diaria_cuadra",)),
    ...
    RunSpec("api-pagos", "8c53f0a", 18, 39, ("test_pasarela_responde_bajo_carga",)),
